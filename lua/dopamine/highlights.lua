...
function M.setup(opts)
  ...
  local highlights = {
    ...
    NeoTreeNormal = { fg = c.cyan, bg = c.bg_hard },
    NeoTreeNormalNC = { fg = c.cyan, bg = c.bg_hard },
    -- NeoTreeRootName = { fg = c.primary },
    NeoTreeRootName = { fg = c.bright_green },
    NeoTreeSymbolicLinkTarget = { fg = c.cyan },
    NeoTreeFloatTitle = { fg = c.float.title },
    NeoTreeFileIcon = { fg = c.magenta },
    NeoTreeDimText = { fg = c.fg_soft },


    -- RenderMarkdown

    RenderMarkdownH1Bg = { bg = c.bright_black },
    RenderMarkdownH2Bg = { bg = c.bright_black },
    RenderMarkdownH3Bg = { bg = c.bright_black },
    RenderMarkdownH4Bg = { bg = c.bright_black },
    RenderMarkdownH5Bg = { bg = c.bright_black },
    RenderMarkdownH6Bg = { bg = c.bright_black },
